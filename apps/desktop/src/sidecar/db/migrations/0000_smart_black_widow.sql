...
--> statement-breakpoint
CREATE INDEX `idx_note_links_from` ON `note_links` (`from_note_id`);--> statement-breakpoint
CREATE INDEX `idx_note_links_to` ON `note_links` (`to_note_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `uq_note_links` ON `note_links` (`from_note_id`,`to_note_id`);--> statement-breakpoint
CREATE INDEX `idx_note_tags_note` ON `note_tags` (`note_id`);--> statement-breakpoint
CREATE INDEX `idx_note_tags_tag` ON `note_tags` (`tag_id`);--> statement-breakpoint
CREATE INDEX `idx_notes_vault` ON `notes` (`vault_id`,`deleted_at`);--> statement-breakpoint
CREATE INDEX `idx_oplog_unsynced` ON `operation_log` (`synced_at`);--> statement-breakpoint
CREATE INDEX `idx_tags_vault` ON `tags` (`vault_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `uq_tags_vault_name` ON `tags` (`vault_id`,`name`);--> statement-breakpoint
